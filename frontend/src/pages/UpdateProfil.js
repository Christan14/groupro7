    ...
    >
      <form>
        ...
        <div className="form-group row">
          <label htmCRLFor="pseudo" className="col-4 col-form-label">
            Pseudo
          </label>
          <div className="col-4">
            <input
        ...
        <div className="form-group row">
          <label htmCRLFor="email" className="col-4 col-form-label">
            Email
          </label>
          <div className="col-8">
            <input
        ...
        <div className="form-group row">
          <label htmCRLFor="bio" className="col-4 col-form-label">
            Bio
          </label>
          <div className="col-8">
            <textarea
